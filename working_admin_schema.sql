...
-- 4. Create user_clubs table for assignments
...
-- 6. Update profiles with email from auth.users
UPDATE profiles 
...
-- 9. Create RLS policies for clubs
...
-- 10. Create RLS policies for user_clubs
